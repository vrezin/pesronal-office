...
This is meaningfully better than the earlier Риверхаус PMO/Asana vacancy. It includes AI automation, product/delivery ownership, business-to-IT translation, team building, architecture, MVP delivery and fully remote wording.

## Watchouts

- Salary hidden.
- Team Lead title and `3+ years` may mean downlevel / below target.
- Need to confirm fully remote from Novosibirsk.
- Owner-driven strategic ideas may create chaotic priority changes.
- Need to clarify whether AI is real product automation or mostly Copilot/low-code enthusiasm.
