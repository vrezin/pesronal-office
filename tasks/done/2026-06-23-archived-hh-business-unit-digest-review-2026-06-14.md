...
- Gmail message id: `19ec53a066478a26`
- Processed note: `inbox/processed/2026-06-14-hh-business-unit-digest-thin-links.md`
...
Fetch or paste full JD text for RWB first, then optionally Lenkep and the `Директор по развитию` role if they still look worth the attention. Do not create full analyses from the digest alone.
