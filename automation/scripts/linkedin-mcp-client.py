...
LINKEDIN_SITE_PACKAGES = REPO_ROOT / "tools" / "linkedin-mcp" / ".venv" / "lib" / "python3.12" / "site-packages"
if LINKEDIN_SITE_PACKAGES.exists():
    sys.path.insert(0, str(LINKEDIN_SITE_PACKAGES))
