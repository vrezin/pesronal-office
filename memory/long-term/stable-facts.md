...
- Personal tools and MCP servers belong in `tools/`.
- ZenMoney MCP is a sensitive personal finance tool and should default to read-only mode unless writes are explicitly requested.
