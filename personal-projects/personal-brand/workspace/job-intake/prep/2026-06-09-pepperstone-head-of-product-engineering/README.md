# Pepperstone Head of Product Engineering Prep

Date: 2026-06-09

This directory holds the working prep packet for the Pepperstone application.

Files:

- `form-fields.md` - copy-ready answers for the application form.
- `interview-prep.md` - short prep notes for screening, interview, and assessment.
