# JD Analysis - 2GIS.RnD - Project Manager AI-трансформации
...
- Remote is explicitly possible, and 2ГИС has a Novosibirsk office.
- The role focuses on moving AI initiatives from ideas and pilots into adoption.
- Strong match to AI-native SDLC / AI adoption consulting language.
- Good local brand and practical logistics compared with Europe/Ireland relocation bets.

## Risks

- Could be PMO/reporting-heavy rather than solution/product architecture.
- Salary hidden.
- Title may weaken the external positioning if treated as the main target.
