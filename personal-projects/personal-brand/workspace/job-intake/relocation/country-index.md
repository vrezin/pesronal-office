...
This is the active shortlist of countries that keep appearing in job intake and relocation discussions.

| Country | Status | Rent | Schools | Safety | Healthcare | Education | Company Help | Self-Relocation | Last Updated | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
...
- Fill or refresh a country row before applying to any role that depends on that country.
- If a new country appears in a vacancy, add it here before it becomes a repeated filter.
- Treat `TBD` as a cue to fetch baseline figures from the internet before making a decision.
