...
- `personal-brand-career` - use for job intake, CV choice, cover letters, vacancy index, company notes, relocation/lifestyle economics, and workspace normalization.
- `automation-monitoring` - use for scheduled HH Gmail monitoring.
