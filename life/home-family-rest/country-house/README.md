...
Management index for the country house personal/family project.
...
- `control/source-data.md` - map of source materials.

## Boundary Decision

This is a personal/family home project, not AI Studio company material.
